...
# input amino acid sequence and BLOSUM62 score matrix
...
# write a function which calculates BLOSUM score
def BLOSUM(a1,a2):
    score=0
...
score_1=BLOSUM(seq_mouse,seq_human)
score_2=BLOSUM(seq_human,seq_random)
score_3=BLOSUM(seq_mouse,seq_random)

# print out the answer
print('The BLOSUM score between human and mouse is',score_1)
print('The BLOSUM score between human and random is',score_2)
print('The BLOSUM score between mouse and random is:',score_3)
